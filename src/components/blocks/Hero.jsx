...
export default function Hero() { 
  return (
    <section className={`${styles.hero}`}>
      <div className={`${styles.hero_content} grid`}>
        <div className={styles.hero_content_logo}>
          <Image className={`${styles.hero_content_logo_icon}`} src="/minus.svg" width={70} height={70} alt='Minus'/> 

          <svg className={styles.hero_content_logo_img} xmlns="http://www.w3.org/2000/svg" width="116.847" height="24.713" viewBox="0 0 116.847 24.713">
        ...
        <div className={`${styles.hero_content_title} ${Larken.className}`}>
          <span>Madrid</span>
          <Image className={styles.hero_content_title_icon} src="/white-arrow2.svg" width={33} height={50} alt='arrow title'/> 
        </div>

        <div className={styles.hero_content_arrow}>
          <Image src="/white-arrow-down.svg" width={33} height={50} alt='arrow down'/> 
        </div>

        <div className={styles.hero_content_badge}>
          <span className={styles.hero_content_badge_text}>Doers School</span>
          <Image className={styles.hero_content_badge_icon} src="/hex-blue.svg" width={50} height={50} alt='hex blue'/>
        </div>
        <div className={styles.hero_content_hex}>
          <p className={styles.hero_content_hex_title}>Ültimos Lugares</p>
          <Image className={styles.hero_content_hex_icon} src="/orange-hex.svg" width={150} height={150} alt='orange hex'/>
        </div>
        <div className={styles.hero_content_box}>
          <LastCourses/>
        </div>
        <div className={styles.hero_content_marquee}>
          <MyMarquee type={"third"}></MyMarquee>
        </div>
      </div>

      <div className={`${styles.hero_bg} grid`}>
        <span className={styles.hero_bg_line}></span>
        <span className={styles.hero_bg_line}></span>
        <Image className={`${styles.hero_bg_item} ${styles.hero_bg_trap}`} src="/green-trap.svg" width={250} height={250} alt='green trap'/> 
        <Image className={`${styles.hero_bg_item} ${styles.hero_bg_dot}`} src="/magenta-circle.svg" width={33} height={33} alt='magenta circle'/> 
        <Image className={`${styles.hero_bg_item} ${styles.hero_bg_blue}`} src="/blue-asterisk.svg" width={52} height={52} alt='blue asterisk'/> 
        <Image className={`${styles.hero_bg_item} ${styles.hero_bg_magent}`} src="/magenta-asterisk.svg" width={60} height={60} alt='magenta asterisk'/> 
        <Image className={`${styles.hero_bg_item} ${styles.hero_bg_hex}`} src="/yellow-hex.svg" width={170} height={170} alt='yellow hex'/> 
      </div>
    </section>
  ) 
}
